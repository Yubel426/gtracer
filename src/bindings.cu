...
public:
    ...
    void trace_backward(
        ...
        torch::Tensor grad_vertices, torch::Tensor grad_opacity, torch::Tensor grad_SinvR, torch::Tensor grad_shs, 
        ...
        triangle_bvh->gaussian_trace_backward(
            ...
            (glm::vec3*)grad_vertices.data_ptr<float>(), grad_opacity.data_ptr<float>(), (glm::mat3x3*)grad_SinvR.data_ptr<float>(), (glm::vec3*)grad_shs.data_ptr<float>(), 
